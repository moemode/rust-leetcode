...
| 2  | [Valid Parentheses](https://leetcode.com/problems/valid-parentheses)              | Easy      | 20 min| 🔄     |                                             |
| 3  | [Merge Two Sorted Lists](https://leetcode.com/problems/merge-two-sorted-lists)    | Easy      | 20 min| 🔄     |                                             |
| 4  | [Best Time to Buy and Sell Stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock)| Easy|20 min| ✅    | [Solution](./lc/src/bin/best-time-stock.rs) |
...
| 13 | [Implement Queue using Stacks](https://leetcode.com/problems/implement-queue-using-stacks)| Easy|20 min| 🔄     |                                             |
...
| 12 | [Maximum Subarray](https://leetcode.com/problems/maximum-subarray)                | Medium    | 20 min| 🔄     |                                             |
...
| 8  | [Evaluate Reverse Polish Notation](https://leetcode.com/problems/evaluate-reverse-polish-notation)| Medium|30 min| 🔄     |                                             |
...
| 2  | [Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree)| Medium|35 min| 🔄     |                                             |
| 3  | [Coin Change](https://leetcode.com/problems/coin-change)                          | Medium    | 25 min| 🔄     |                                             |
| 4  | [Product of Array Except Self](https://leetcode.com/problems/product-of-array-except-self)| Medium|30 min| 🔄     |                                             |
| 5  | [Min Stack](https://leetcode.com/problems/min-stack)                              | Medium    | 20 min| 🔄     |                                             |
| 6  | [Validate Binary Search Tree](https://leetcode.com/problems/validate-binary-search-tree)| Medium|20 min| 🔄     |                                             |
| 7  | [Number of Islands](https://leetcode.com/problems/number-of-islands)              | Medium    | 25 min| 🔄     |                                             |
| 8  | [Rotting Oranges](https://leetcode.com/problems/rotting-oranges)                  | Medium    | 30 min| 🔄     |                                             |
...
| 5  | [Lowest Common Ancestor of a Binary Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree)| Medium|25 min| 🔄     |                                             |
| 6  | [Time Based Key-Value Store](https://leetcode.com/problems/time-based-key-value-store)| Medium|35 min| 🔄     |                                             |
| 7  | [Accounts Merge](https://leetcode.com/problems/accounts-merge)                    | Medium    | 30 min| 🔄     |                                             |
| 8  | [Sort Colors](https://leetcode.com/problems/sort-colors)                          | Medium    | 25 min| 🔄     |                                             |

## Week 6 - Medium

| No | Problem                                                                           | Difficulty | Time | Status | Solution                                    |
|----|-----------------------------------------------------------------------------------|-----------|------|--------|---------------------------------------------|
| 1  | [Word Break](https://leetcode.com/problems/word-break)                            | Medium    | 30 min| 🔄     |                                             |
...
| 9  | [Construct Binary Tree from Preorder and Inorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal)| Medium|25 min| 🔄     |                                             |

## Week 7 - Medium/Hard

| No | Problem                                                                           | Difficulty | Time | Status | Solution                                    |
|----|-----------------------------------------------------------------------------------|-----------|------|--------|---------------------------------------------|
| 1  | [Container With Most Water](https://leetcode.com/problems/container-with-most-water)| Medium|35 min| 🔄     |                                             |
| 2  | [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number)| Medium|30 min| 🔄     |                                             |
| 3  | [Word Search](https://leetcode.com/problems/word-search)                          | Medium    | 30 min| 🔄     |                                             |
| 4  | [Find All Anagrams in a String](https://leetcode.com/problems/find-all-anagrams-in-a-string)| Medium|30 min| 🔄     |                                             |
| 5  | [Minimum Height Trees](https://leetcode.com/problems/minimum-height-trees)        | Medium    | 30 min| 🔄     |                                             |
| 6  | [Task Scheduler](https://leetcode.com/problems/task-scheduler)                    | Medium    | 35 min| 🔄     |                                             |
| 7  | [LRU Cache](https://leetcode.com/problems/lru-cache)                              | Medium    | 30 min| 🔄     |                                             |

## Week 8 - Hard

| No | Problem                                                                           | Difficulty | Time | Status | Solution                                    |
|----|-----------------------------------------------------------------------------------|-----------|------|--------|---------------------------------------------|
| 1  | [Kth Smallest Element in a BST](https://leetcode.com/problems/kth-smallest-element-in-a-bst)| Medium|25 min| 🔄     |                                             |
| 2  | [Minimum Window Substring](https://leetcode.com/problems/minimum-window-substring)| Hard      | 30 min| 🔄     |                                             |
| 3  | [Serialize and Deserialize Binary Tree](https://leetcode.com/problems/serialize-and-deserialize-binary-tree)| Hard|40 min| 🔄     |                                             |
| 4  | [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water)          | Hard      | 35 min| 🔄     |                                             |
| 5  | [Find Median from Data Stream](https://leetcode.com/problems/find-median-from-data-stream)| Hard|30 min| 🔄     |                                             |
| 6  | [Word Ladder](https://leetcode.com/problems/word-ladder)                          | Hard      | 45 min| 🔄     |                                             |
| 7  | [Basic Calculator](https://leetcode.com/problems/basic-calculator)                | Hard      | 40 min| 🔄     |                                             |
| 8  | [Maximum Profit in Job Scheduling](https://leetcode.com/problems/maximum-profit-in-job-scheduling)| Hard|45 min| 🔄     |                                             |
| 9  | [Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists)        | Hard      | 30 min| 🔄     |                                             |
| 10 | [Largest Rectangle in Histogram](https://leetcode.com/problems/largest-rectangle-in-histogram)| Hard|35 min| 🔄     |                                             |
